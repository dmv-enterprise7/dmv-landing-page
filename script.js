...
var translations = {
  pt: {
    ...
    'why-ai.transition': 'A pergunta não é SE IA transforma negócio. É ONDE ela transforma o SEU. E onde automação simples já resolve.',
    ...
    'services.card1.desc': 'Atendimento 24h que qualifica leads, responde dúvidas e agenda reuniões. Com escalada humana nos casos que pedem decisão sensível. Automatiza o previsível, não o que precisa de gente.',
    ...
    'about.intro': 'Somos três sócios com papéis complementares: vendas, tecnologia e operação. Unidos por uma convicção: IA só entrega valor quando nasce do entendimento profundo do negócio.',
    'about.tagline': 'Driven Mind Vanguard: Vanguarda da Mente Direcionada.',
    'about.founder1.specialty': 'CEO. Vendas, relacionamento e conteúdo.',
    'about.founder2.specialty': 'CTO. Produto, código e infra.',
    'about.founder3.specialty': 'COO. Operação, financeiro e jurídico.',
  ...
  en: {
    ...
    'why-ai.stat6.source': 'Sales So / Industry Data',
    'why-ai.transition': 'The question isn\'t IF AI transforms business. It\'s WHERE it transforms YOURS. And where simple automation already solves it.',
    ...
    'services.card1.desc': '24/7 support that qualifies leads, answers questions, and books meetings. With human escalation for cases that require sensitive judgment. We automate the predictable, not what needs people.',
    ...
    'about.intro': 'We\'re three partners with complementary roles: sales, technology, and operations. United by one conviction: AI only delivers value when it\'s born from a deep understanding of the business.',
    'about.tagline': 'Driven Mind Vanguard.',
    'about.founder1.specialty': 'CEO. Sales, relationships, and content.',
    'about.founder2.specialty': 'CTO. Product, code, and infrastructure.',
    'about.founder3.specialty': 'COO. Operations, finance, and legal.',
