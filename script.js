...
var translations = {
  pt: {
    ...
    'pain.title': 'Isso é familiar?',
    'pain.item1': 'Perde clientes porque demora para responder',
    'pain.item2': 'WhatsApp comercial virou uma bagunça',
    'pain.item3': 'Preso em tarefas manuais que não acabam',
    'pain.item4': 'Atendimento que muda de qualidade conforme o dia',
    'pain.transition': 'A DMV resolve cada um desses problemas com Inteligência Artificial.',
    'services.title': 'Soluções sob medida para o seu negócio',
    'services.subtitle': 'Cada sistema que criamos é único \u2014 desenhado para o seu nicho, seus processos e seus objetivos.',
    ...
    'how.subtitle': 'Três passos para transformar o seu negócio com IA',
    'how.step1.title': 'Conversa Inicial',
    'how.step1.desc': 'Entendemos seu negócio, seus processos e seus objetivos em uma reunião gratuita.',
    'how.step2.title': 'Solução Sob Medida',
    'how.step2.desc': 'Desenvolvemos o sistema de IA ideal para o seu caso \u2014 sem templates genéricos.',
    'how.step3.title': 'Resultados na Prática',
    'how.step3.desc': 'Implementamos, treinamos e acompanhamos os resultados junto com você.',
    'how.cta': 'Agende agora \u2014 é 100% gratuito',
    'diff.title': 'Por que a DMV?',
    'diff.subtitle': 'Não somos mais uma agência. Somos parceiros de resultado.',
    'diff.item1.title': '100% Personalizado',
    'diff.item1.desc': 'Nenhum sistema idêntico ao outro. Cada solução é criada do zero para o seu negócio.',
    'diff.item2.title': 'Atendimento Humano e Próximo',
    'diff.item2.desc': 'Você fala diretamente com quem cria. Sem intermediários, sem rodeios.',
    'diff.item3.title': 'Foco em Resultado Prático',
    'diff.item3.desc': 'Não vendemos tecnologia por tecnologia. Cada sistema tem um ROI claro.',
    'diff.item4.title': 'Funciona 24 horas, 7 dias',
    'diff.item4.desc': 'Seus assistentes nunca dormem. Atendimento e automação rodando sempre.',
    ...
    'faq.q1': 'Quanto custa?',
    'faq.a1': 'Cada projeto é orçado individualmente. Oferecemos uma reunião 100% gratuita \u2014 sem compromisso.',
    'faq.q2': 'Preciso entender de tecnologia?',
    'faq.a2': 'Não. Cuidamos de tudo técnico. Você só precisa nos contar sobre o seu negócio.',
    'faq.q3': 'Funciona para o meu segmento?',
    'faq.a3': 'Sim. Já implementamos soluções para clínicas, e-commerces, prestadores de serviço, escritórios e mais. Se o seu negócio atende clientes, a IA pode ajudar.',
    'faq.q4': 'Quanto tempo leva para implementar?',
    'faq.a4': 'Depende da complexidade, mas a maioria das soluções fica pronta em 7 a 21 dias.',
    'faq.q5': 'E se eu não gostar do resultado?',
    'faq.a5': 'Trabalhamos em ciclos de ajuste até você estar 100% satisfeito. Sua satisfação é nossa entrega.',
    'faq.q6': 'Vocês dão suporte depois?',
  ...
  en: {
    ...
    'how.cta': 'Schedule now \u2014 it\'s 100% free',
    'diff.title': 'Why DMV?',
    ...
    'faq.a1': 'Each project is quoted individually. We offer a 100% free meeting \u2014 no commitment.',
